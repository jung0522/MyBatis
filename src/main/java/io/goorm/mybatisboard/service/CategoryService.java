...
import io.goorm.mybatisboard.mapper.CategoryMapper;
...
public class CategoryService {
     ...
     */
    public PageDto<CategoryDto> findAllWithConditions(CategorySearchConditionDto condition) {
    ...
    public PageDto<CategoryDto> findByActiveStatus(boolean isActive, int page, int size) {
        CategorySearchConditionDto condition = CategorySearchConditionDto.builder()
                .isActive(isActive)
                .page(page)
                .size(size)
                .build();
