-- posts 테이블에 컬럼 추가
ALTER TABLE posts ADD COLUMN category_id BIGINT DEFAULT 2;
ALTER TABLE posts ADD COLUMN status VARCHAR(20) DEFAULT 'PUBLISHED';
ALTER TABLE posts ADD COLUMN author_name VARCHAR(100) DEFAULT '작성자';
ALTER TABLE posts ADD COLUMN view_count INT DEFAULT 0;
ALTER TABLE posts ADD COLUMN is_notice BOOLEAN DEFAULT FALSE;
